...
Data files for the lesson are available and can be downloaded manually here: <https://www.dropbox.com/s/4fqgi6t3so69224/Sinal_Langille_raw_data.tar.gz>
...
install RStudio. After installing both programs, you will need to install some packages from within RStudio. Follow the instructions below for
your operating system, and then follow the instructions to install the 
**`tidyverse`** and **`phyloseq`** packages.
