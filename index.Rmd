...
in working with metagenomic data in R.
...
and install the required software *before* working through this lesson.

### Data

The required data files for the workshop will be available on the HPC.

However, if you wish to download the data files manually for future reference, these are available here: <https://www.dropbox.com/s/4fqgi6t3so69224/Sinal_Langille_raw_data.tar.gz>
...
* After starting RStudio, at the console type:
  `install.packages(c("tidyverse", "phyloseq"))`
